# Wake Drive 1.0.0 · 위치·광고·통계 없는 버전

2026-09-11 · Android versionCode 27 · com.hjsolution.jolbang

위치 권한과 GPS 속도 표시, AdMob 광고 및 Firebase Analytics SDK를 제거했습니다. 인터넷 권한 없이 앱에 포함된 모델로 감지하고, 한국어 10편·영어 2편 영상을 광고 없이 사용합니다. 사용자에게 요청하는 런타임 권한은 카메라입니다. 기존 언어와 영상 선택은 유지합니다.

현재 debug APK를 연결된 SM-F711N에 업데이트했습니다. 출시 APK와 AAB 빌드도 완료했지만 **미서명**입니다. 운영자 에이치제이솔루션, 문의 hjshub@jnmdisplay.com, 정책 https://www.hjshub.com/privacy 를 앱에 반영했습니다. 업로드 키, 공개 정책의 Wake Drive 범위 수정, Play Console 신고와 최종 배포 테스트가 남았습니다. 스토어 제출 완료 또는 심사 통과 상태가 아닙니다.
...
0.1.20~0.1.24 변경 및 당시 검증 결과는 docs/README-before-1.0.0.md, 최초 원본 문서는 docs/SOURCE_README.md에 보존했습니다. 이전 문서의 GPS·광고·통계 설명은 현재 버전의 동작이 아닙니다.
